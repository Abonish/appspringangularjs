...
public class AppspringangularjsApp {

    private static final Logger log = LoggerFactory.getLogger(AppspringangularjsApp.class);

    private final Environment env;

    public AppspringangularjsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes appspringangularjs.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AppspringangularjsApp.class);
